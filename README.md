...
>127.0.0.1:1234
>
>Auto detection of the host local ipv4 and subnet mask. Populates a range of local ip addresses from 0 - 255 to scan using the ping ICMP protocol on the LAN within the range of the host subnet.
